    ...
    <>
      ...
      <AfgLayout location={location} chapter="debt">
        ...
        <div className="cards">
          ...
          <section className="card">
            <div className="card__contents">
              ...
              At the end of
              {' '}
              {AfgData.tic_date.value}
              ,
              {' '}
              {AfgData.debt_owned_us_investors.value}
              {' '}
              of federal debt was owned by investors from the United States, including the Federal Reserve. The various trust funds operated by the United States government, like the Social Security and Medicare trust fund accounts, held another
              {' '}
              {AfgData.debt_owned_trust_funds.value}
              {' '}
              of federal debt. Foreign investors owned the remaining
              {' '}
              {AfgData.debt_owned_foreign_investors.value}
              {' '}
              of federal debt. For a complete list of foreign investors, visit the
              {' '}
              <a href={AfgData.tic_foreign_holders.value} target="_blank" rel="noopener noreferrer">Treasury International Capital (TIC) System</a>
              .
            </div>
          </section>
        </div>
        ...
        <section className="tour">
          ...
          <a href="/americas-finance-guide/debt/country-comparison/" className="tour__link">
            Continue
        ...
        <section className="hwcta">
          <AccordionList title="Data Sources and Methodology">
            <p>
              ...
              <a href={AfgData.current_mspd.value} target="_blank" rel="noopener noreferrer"> Monthly Statement of the Public Debt (MSPD)</a>
              ...
              <a href={AfgData.soma_domestic_securities.value} target="_blank" rel="noopener noreferrer">System Open Market Account (SOMA)</a>
