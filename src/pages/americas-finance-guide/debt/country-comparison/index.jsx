				...
				<div className="country-common-wrapper">
					...
					<div className="country-copy">
						<div className="country-copy__text">
							<p>
								How does the United States compare to countries of similar size and gross domestic product?
								Explore the chart, which shows the total federal debt of the United States compared to total
								government debt of {AfgData.countries_compared_debt.value} other countries.  You can compare
								total debt (in dollars) and debt as a percent of gross domestic product. Find a country
								of interest and see for yourself. Because the U.S. government has more money coming in
								and going out than any other country, it helps to compare the debt of the U.S. government
								to other countries based on the size of their economies. To ensure an accurate comparison,
								{' '}{AfgData.country_compare_year.value} debt data is used in this section, not current fiscal year data.
							</p>
							<p>
								<em>
									Please note that the countries depicted in this chart have different forms of government,
									and these differences may impact the scope of finances reported by each country.
								</em>
							</p>
						</div>
					...
					<section className="hwcta">
						<AccordionList title="Data Sources and Methodology">
							<p>
								...
								. These sources were chosen because they provide the best comparison for the following reasons:
								<ul>
									<li>
							...
							<p>
								Countries without {AfgData.country_compare_year.value} figures were excluded from the
								country comparison data set, as well as countries reporting only general government figures.
								General government figures include province, state, and local debt and are not as useful
								of a comparison to federal financial figures for the United States. Some governments rely
								on provincial, state, or local debt than on the central government, and as a result, this
								visualization should not be considered an absolute comparison of the debt of central
								governments for all countries.
							</p>
							<p>
								...
								{' '}published by the US Treasury for {AfgData.conversion_date.value}. Countries were
								excluded that did not have both debt, and exchange rate data available.
							</p>
							<p>
								The conversion of debt figures to U.S. dollars makes comparisons among countries more
								convenient. However, the implied burden of debt may be misrepresented for a given country
								if the majority of that nation’s debt was represented in a currency other than U.S. dollars,
								and the currency in which the debt was held had an abnormal valuation relative to the U.S.
								dollar on the date of currency conversion.
							</p>
