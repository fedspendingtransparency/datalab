        ...
        <div className="trends-common-wrapper debt-trends-wrapper">
          ...
          <aside className="debt-aside">
            <p>
              ...
              . Another way to view the federal debt over time is to look at the ratio of federal debt related to gross domestic product (GDP). This ratio has also increased over time. According to the most recent
              {' '}
              <a href={AfgData.financial_report.value} rel="noopener noreferrer" target="_blank">Financial Report of the United States Government (FR)</a>
