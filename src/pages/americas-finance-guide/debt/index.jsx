...
function ExploreDebtPage({ location }) {
	...
	const [vizComponent, updateVizComponent] = useState(
		<DebtIntro selection={activeLayer} />
	);
					...
					<div className="debt-intro">
						...
						<div className="viz-wrapper-debt">
							...
							<section id="mobile-gdp-facts" className="facts__section">
								<h1>U.S. Economy</h1>
								<p>
									By comparing the total federal debt to gross domestic product (GDP), we
									can observe the government's ability to utilize the resources at hand
									to finance the debt the same way you and your family manage your
									finances to make sure that your monthly payments for your mortgage, car
									loans, and credit cards can be made.
								</p>
							</section>
							<div className={styles.debtCopyMobile}>
								<p>
									How did we end up with&nbsp;
									{AfgData.current_fy_debt.value} in federal debt? When the U.S.
									government has a deficit, most of the deficit spending is covered by
									the government taking on new debt. It is similar to a person using his
									or her credit card for a purchase (rather than cash, check, or a debit
									card) and not paying the full credit card balance each month. Over the
									years, if the federal government experiences more deficits than
									surpluses, the federal debt grows.
								</p>
						...
						<AccordionList title="Data Sources and Methodology">
							...
							<div className="afg__download--div">
								...
								<ul>
									<li>
										<a
											href="/americas-finance-guide/data/explore_federal_debt.csv"
