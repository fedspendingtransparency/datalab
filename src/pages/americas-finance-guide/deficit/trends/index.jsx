			...
			<AfgLayout location={props.location} chapter={'deficit'}>
				<div className="cg-wrapper trends-common-wrapper deficit-trends-wrapper">
					...
					<aside className="deficit-aside">
						<p>
							Since {AfgData.last_surplus.value}, the U.S. has experienced a deficit
							each year. Beginning in 2016, increases in spending on Social Security,
							health care, and interest on federal debt have outpaced the growth of
							federal revenue.
						</p>
						<p>
							In {AfgData.current_fy.value}, federal spending increased in response to
							the COVID-19 pandemic. Visit our{' '}
								...
								<div className="accordion__content">
									<div id="surplusComponent">
										<div className="deficit--surplus__component--content deficit--surplus__surplus">
											...
											spends. The last surplus for the federal government was in{' '}
										...
										<div className="deficit--surplus__component--content deficit--surplus__balanced">
											<img
												...
												alt=""
												role="presentation"></img>
											A balanced budget occurs when the amount the government spends equals
											the amount the government collects. Sometimes the term balanced
											budget is used more broadly to refer to instances where there is no
											deficit.
										</div>
										<div className="deficit--surplus__component--content deficit--surplus__deficit">
											<img
												...
												alt=""
												role="presentation"></img>
											A deficit occurs when the government spends more money than it
											collects. The federal government has run deficits for the last{' '}
											{AfgData.consecutive_deficits.value} years.
										</div>
									</div>
								</div>
							</AccordionList>
						...
						<section className="tour">
							<div className="tour__part-one">
								<h1>
									How does the deficit in the United States compare to other countries?
								</h1>
								<p>
									When you are done here, see how the U.S. deficit compares to other
									countries.
								</p>
							</div>
							<a
