			...
			<div className="facts__inner">
				<div id="compare-options">
					...
					<div className="facts__triggers">
						<button
							id="data-trigger-deficit"
							className="facts__trigger"
							data-trigger-id="deficit">
							Deficit
						</button>
						<button
							id="data-trigger-debt"
							className="facts__trigger"
							data-trigger-id="debt">
							Debt
						</button>
					</div>
				</div>
				...
				<section id="debt-facts" className="facts__section">
					<p>
						To pay for a deficit, the government takes on debt. The total debt that
						the government owes is essentially the accumulation of deficits over time,
						minus repayments of debt.
					</p>
					<p>
						*The&nbsp;
						{AfgData.added_debt_short.value} increase in federal debt actually
						consists of the&nbsp;
						{AfgData.current_fy_deficit_short.value} deficit along with changes to
						operating cash balance, intergovernmental holdings, and other financial
						activities. In the visualization, the operating cash balance,
	...
	return (
		<>
			<SEO
				...
				keywords={[
					'Deficit, federal deficit, national deficit, spending, revenue, U.S. deficit money going out, money coming in, debt, national debt, federal debt, deficit vs. debt',
				]}
			/>
				...
				<div className="chapter-intro-common-wrapper deficit-intro-wrapper">
					<div className="deficit-intro">
						...
						<div className="viz-wrapper">
							{renderVizComponent()}
							<section
								className={`accordion sidebar ${
									isMobile && isReady ? '' : 'intro-hidden'
								}`}>
							...
							<section className="tour sidebar intro-hidden desktop-only">
								...
								<a
									href="/americas-finance-guide/deficit/trends/"
						...
						<div className="info-box" id="per-individual">
							...
							<p>
								...
								, {AfgData.current_fy_deficit.value} would be equivalent to a little
								less than&nbsp;
						...
						<AccordionList title="Data Sources and Methodology">
							...
							<div className="afg__download--div">
								...
								<ul>
									<li>
										<a
											href="/americas-finance-guide/data/explore_federal_deficit.csv"
											download="explore_federal_deficit.csv">
											explore_federal_deficit.csv
										</a>
									</li>
								</ul>
							</div>
