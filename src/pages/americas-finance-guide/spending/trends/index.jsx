	...
	const breadcrumbs = (
		<section className="tour tour__spending-trends">
			<div className="tour__part-one">
				<h1>
					How does federal spending in the United States compare to other countries?
				</h1>
				<p>
					When you're done here, see how federal spending by the U.S. compares to
					other countries.
				</p>
			</div>
			<a
				className="tour__link"
				href="/americas-finance-guide/spending/country-comparison/">
				Continue
				<FontAwesomeIcon
					icon={faAngleRight}
					width={7}
	...
	return (
		<>
			<SEO
				...
				keywords={[
					`federal spending, , revenue, federal revenue, U.S. spending, gross domestic product, GDP, deficit, debt, federal spending trends over time`,
				]}
			/>
			<Og
				socialMediaImage={
					...
					<div className="trend-flex">
						<div className="trend-copy">
							<div className="trend-copy__text">
								<p>
									How has spending changed over the past few years? This chart presents
									federal spending by category or by agency over a{' '}
									{AfgData.number_trend_years.value} year period. Have there been
									significant changes in federal spending? What impact does an increase
									or decrease have on spending at the subcategory level?
								</p>
								<p>
									You can track trends in federal spending by category or subcategory.
								</p>
							</div>
						...
						<div className="trend-chart">
							<div
								...
								className="toggle-component toggle-component--spending clearfix"
					...
					<section className="hwcta">
						<AccordionList title="Data Sources and Methodology">
							<p>
								...
								was used to adjust spending in fiscal years{' '}
							...
							<div className="afg__download--div">
								...
								<ul>
									<li>
										<a
											href="/americas-finance-guide/data/federal_spending_trends.csv"
											download="federal_spending_trends.csv">
											federal_spending_trends.csv
										</a>
									</li>
								</ul>
							</div>
