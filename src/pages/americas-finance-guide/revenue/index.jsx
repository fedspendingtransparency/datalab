	...
	return (
		<>
			<SEO
				...
				keywords={[
					'revenue, federal revenue, U.S. revenue, gdp, receipts, income taxes, corporate taxes',
				]}
			/>
			...
			<AfgLayout location={location} chapter="revenue">
				<div className="chapter-intro-common-wrapper revenue-intro-wrapper">
					...
					<h1>
						In {AfgData.current_fy.value}, the government collected{' '}
						{AfgData.current_fy_revenue.value} in revenue.
					...
					<div className="info-box" id="per-individual">
						<img src={AnecdoteRevenueSVG} alt="anecdote icon" />
						<p>
							How much is {AfgData.current_fy_revenue.value}? If you divide it by the
					...
					<div className="viz-wrapper">
						...
						{activeLayer === 'spending' && (
							<div className={styles.mobileCopy}>
								<p className={styles.mobileCopyHeading}>
									In Fiscal Year {AfgData.current_fy.value}, the federal government spent{' '}
						...
						{activeLayer === 'gdp' && (
							<div className={styles.mobileCopy}>
								<p className={styles.mobileCopyHeading}>
									In Fiscal Year {AfgData.current_fy.value}, federal revenue was equal to{' '}
									{AfgData.revenue_percent_gdp.value} of total gross domestic product
						...
						<div id="copy" className={`intro-hidden ${styles.mainMobileCopy}`}>
							<p>
								...
								part of the
								{AfgData.current_fy_revenue.value}. Federal revenue consists mostly of
								individual, corporate, and social insurance taxes collected from the
								people who live, work, or do business in the United States each Fiscal
								Year.
								...
								<div id="compare-options">
									...
									<div className="facts__triggers">
										<button
											...
											id="facts__trigger-spending"
											data-trigger-id="spending">
											Federal Spending
										</button>
										<button
											className="facts__trigger"
											id="facts__trigger-gdp"
											data-trigger-id="gdp">
											U.S. Economy
										</button>
									</div>
					...
					{/* end viz-wrapper  */} {/* end ffg-wrapper revenue-intro */}
