...
function RevenueAndGdpPage(props) {
    ...
    const handleResize = () => {
        updateVizComponent(!isMobileDevice() ?
            <RevenueIntro selection={activeLayer} setDesktopActiveLayer={setDesktopActiveLayer}/> :
    ...
    return (
        <>
            <SEO
                ...
                description={`In ${AfgData.current_fy.value}, the government collected ${AfgData.current_fy_revenue_short.value} in revenue. If you lived or worked in the U.S. in ${AfgData.current_fy.value}, most likely your contributions are part of the ${AfgData.current_fy_revenue_short.value}.`}
            ...
            <AfgLayout location={props.location} chapter={'revenue'}>
                <div className="chapter-intro-common-wrapper revenue-intro-wrapper">
                    ...
                    <div className="info-box" id="fiscal-year">
                        <img src={AnecdoteRevenueSVG} alt="anecdote icon"/>
                        <p>
                            Fiscal Year refers to the period of time used by the government for accounting and budget
                            purposes.
                    ...
                    <div className="info-box" id="per-individual">
                        ...
                        <p>
                            ...
                            (
                            <a href={AfgData.census_population.value} target="_blank" rel="noopener noreferrer">U.S.
                                Census Bureau</a>
                    ...
                    <div className="viz-wrapper">
                        ...
                        <div id="copy" className="intro-hidden">
                            <p>
                                ...
                                corporate, and social insurance taxes collected from the people who live, work, or do
                                business in the United States each Fiscal Year.
                                <button className="info-box-trigger" data-box-id="fiscal-year"><img
                                    src={AnecdoteRevenueSVG} alt="anecdote icon"/></button>
                            </p>
                        </div>
                        <div className="facts sidebar intro-hidden">
                            <div className="facts__inner">
                                <div id="compare-options">
                                    <p className="facts__prompt">How does federal revenue compare to federal spending
                                        and the size of the economy?</p>
                                    <div className="facts__triggers">
                                        <button className="facts__trigger" data-trigger-id="spending">Federal Spending
                                        </button>
                                ...
                                <section id="gdp-facts" className="facts__section">
                                    <h1>
                                        ...
                                        {' '}
                                        of total gross domestic product (GDP), or economic activity, of the United
                                        States that year (
                                        {AfgData.current_fy_gdp.value}
                                        ).
                                    </h1>
                                    <p>Why do we compare federal revenue to gross domestic product? For one, the
                                        comparison serves as a rough gauge of the size of the federal government's
                                        footprint related to size of the entire country's economic activity. In
                                        addition, federal taxes are based on a percentage of income for people and
                                        businesses. If an economy is performing well, people and businesses earn more,
                                        and federal revenue from taxes increases.</p>
                                    <strong>
                        ...
                        <section className="tour sidebar intro-hidden">
                            ...
                            <a href="/americas-finance-guide/revenue/categories/" id="tour-continue"
                    ...
                    <section className="hwcta">
                        <AccordionList title="Data Sources and Methodology">
                            <p>
                                ...
                                <GdpTemplate/>
                                {' '}
                                The revenue-to-gross domestic product ratio is included to provide you with context for
                                the trillions of dollars that come in to the federal government annually. Throughout
                            ...
                            <div className="afg__download--div">
                                ...
                                <ul>
                                    <li>
                                        <a href="/americas-finance-guide/data/federal_revenue_gdp.csv"
                                           download="federal_revenue_gdp.csv">federal_revenue_gdp.csv</a>
                                    </li>
                                </ul>
                            </div>
                        </AccordionList>
