			...
			<AfgLayout location={location} chapter="revenue">
				<div className="chapter-intro-common-wrapper revenue-intro-wrapper">
					...
					<div className="info-box" id="per-individual">
						<img src={AnecdoteRevenueSVG} alt="anecdote icon" />
						<p>
							How much is {AfgData.current_fy_revenue.value}? If you divide it
							by the U.S. population estimate in {AfgData.current_fy.value},{" "}
						...
						{activeLayer === "gdp" && (
							<div className={styles.mobileCopy}>
								...
								<p className={styles.mobileCopySubheading}>
									...
									For one, the comparison serves as a rough gauge of the size of
									the federal government's footprint related to size of the
									entire country's economic activity. In addition, federal taxes
									are based on a percentage of income for people and businesses.
									If an economy is performing well, people and businesses earn
									more, and federal revenue from taxes increases.
								</p>
