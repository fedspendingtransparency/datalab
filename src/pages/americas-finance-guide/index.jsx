      ...
      <Default>
        ...
        <div className="cg-wrapper bp-wrapper">
                          ...
                          <div className="anecdote__panes">
                            ...
                            <div className="anecdote__pane">
                              <p>
                                ...
                                in spending
                                {' '}
                                <strong>per U.S. individual</strong>
                                .
                              </p>
                            ...
                            <div className="anecdote__pane">
                              <p>
                                {AfgData.current_fy_spending.value}
                                {' '}
                                is equivalent to building a new
                                {' '}
                                <strong>
                                  four-lane road from Washington D.C. to San Francisco and back...
                        ...
                        <div className="anecdote__nav-contents">
                          ...
                          <div className="anecdote__panes">
                            ...
                            <div className="anecdote__pane">
                              ...
                              <img role="presentation" className="anecdote__illustration" src="/americas-finance-guide/images/deficit-3-outline.svg" alt="" />
                            </div>
                          </div>
                        </div>
                        <div className="anecdote__nav-control" />
          ...
          <div className="historical-quote">
            ...
            <img role="presentation" className="historical-quote__image" src="/americas-finance-guide/images/jefferson.png" alt="" />
          ...
          <div className="about-us">
            ...
            <p className="about-us__main-copy">
              ...
              {' '}
              <a href={AfgData.citizens_guide_link.value} rel="noopener noreferrer" target="_blank">Citizen’s Guide to the Financial Report of the U.S. Government</a>
            ...
            <p className="about-us__source">
              ...
              {' '}
              is brought to you by the U.S. Department of the Treasury
            </p>
            <img src="/americas-finance-guide/images/treasury-seal.svg" className="about-us__logo" alt="U.S. Treasury Logo" />
          </div>
        </div>
      </Default>
      <AfgAnecdote />
