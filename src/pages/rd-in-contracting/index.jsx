	...
	sections = [
		{
			...
			anchor: 'spending',
			header: (
				<div className={styles.title} key={'spending-header'}>
					2019 Agency Spending
				</div>
			),
			sectionTeaser: (
				<>
		...
		},
		{
			...
			anchor: 'categories',
			header: (
				<div className={styles.title} key={'categories-header'}>
		...
		},
		{
			...
			anchor: 'studies',
			header: (
				<span className={styles.title} key={'studies-header'}>
					The Big Picture for R&D
				</span>
			),
			sectionTeaser: (
				<>
