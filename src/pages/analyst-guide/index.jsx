...
const AnalystGuidePage = ({ location }) => {
	...
	const introSentence = (
		<>
			<p>
				Welcome to the Analyst’s Guide to Federal Spending Data. Here, you’ll find
				guidance on effectively using USAspending.gov data, making it easier for you
				to conduct your own analyses and develop tools using federal spending data.
			</p>
			<p>
				If you’d like to recommend a question to be added to this guide, please
				share it on our Community page.
			</p>
		</>
	);
	const rawContent = [
