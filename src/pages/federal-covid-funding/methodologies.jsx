...
const C19HWTCA = ({ location }) => {
  ...
  const methodologies = [{
    ...
    sources: (
      <ul>
        <li>
          The value of the four supplemental laws passed by Congress is approximately $2.3 trillion. This value reflects the total value of appropriation warrants made to agency's TAS accounts for each of the four laws passed.
        </li>
        <li>
