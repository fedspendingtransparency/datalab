  ...
  const methodologies = [{
    ...
    sources: (
      <ul>
        ...
        <li>
          Agency totals were aggregated using TAS account data at the Allocation Transfer Agency (ATA) identifier. In cases where the ATA is null, the Agency Identifier (AID) is used, with a few exceptions. Agencies that use a shared AID were aggregated using the Financial Reporting Entity Code (FREC), and certain armed forces agencies were classified as Department of Defense following the logic used to classify agencies on USAspending.gov<a href="#fn18" className="footnoteref"><FootnoteAnchor footnoteId="fr18" />18</a>
        </li>
      </ul>
    )
  }];
    ...
    content: (
      <>
        ...
        <p>
          ...
          <sup><a href="#fr14">14</a></sup>Data on loans disbursed by USDA’s Rural Development Business and Industry CARES Act Program can be accessed using USAspending’s COVID-19 Advanced Search Filter: <a target="_blank" href="https://www.usaspending.gov/#/search/5d9262dee1d2962a1760f28b16945333">https://www.usaspending.gov/#/search/5d9262dee1d2962a1760f28b16945333</a>
        </p>
        <p>
          <FootnoteAnchor footnoteId="fn15" />
          <sup><a href="#fr15">15</a></sup> OMB Guidance on reporting requirements and DEFC values provided for the four laws are provided in OMB M20-21: <a target="_blank" href="https://www.whitehouse.gov/wp-content/uploads/2020/04/Implementation-Guidance-for-Supplemental-Funding-Provided-in-Response.pdf">https://www.whitehouse.gov/wp-content/uploads/2020/04/Implementation-Guidance-for-Supplemental-Funding-Provided-in-Response.pdf</a>
        </p>
        <p>
          <FootnoteAnchor footnoteId="fn16" />
          <sup><a href="#fr16">16</a></sup> Values were calculated according to the USSGL Supplement of the Treasury Financial Manual - Section V: Crosswalks to Standard External Reports for FY 2020 GTAS Reporting, SF 133: Report on Budget Execution and Budgetary Resources & Schedule P Budget Program and Financing Schedule. <a target="_blank" href="https://tfm.fiscal.treasury.gov/content/dam/tfm/v1/supplements/ussgl/ussgl_part_1/sec5/sec5_sf133_schp_2020.xlsx">https://tfm.fiscal.treasury.gov/content/dam/tfm/v1/supplements/ussgl/ussgl_part_1/sec5/sec5_sf133_schp_2020.xlsx</a>
        </p>
        <p>
          <FootnoteAnchor footnoteId="fn17" />
          <sup><a href="#fr17">17</a></sup> GTAS data is collected monthly and agencies report data for all transactions occurring through the end of the prior month. The GTAS reporting schedule can be found here: <a target="_blank" href="https://fiscal.treasury.gov/files/gtas/fy-2020-reporting-window-schedule.pdf ">https://fiscal.treasury.gov/files/gtas/fy-2020-reporting-window-schedule.pdf</a>
        </p>
        <p>
          <FootnoteAnchor footnoteId="fn18" />
          <sup><a href="#fr18">18</a></sup> Detailed instructions on how agencies should be classified is provided here: <a target="_blank" href="https://github.com/fedspendingtransparency/data-act-broker-backend/blob/development/FileLogic.md">https://github.com/fedspendingtransparency/data-act-broker-backend/blob/development/FileLogic.md.</a>
