						...
						<Hidden smDown>
							<div id={categoriesStyles.legendColorkey}>
								...
								<svg id={categoriesStyles.legendScalekey}>
									<circle r="25" className={categoriesStyles.legendScalekeyCircle} cx="60" cy="65" />
									<circle r="35" className={categoriesStyles.legendScalekeyCircle} cx="60" cy="65" />
									<circle r="45" className={categoriesStyles.legendScalekeyCircle} cx="60" cy="65" />
								</svg>
							</div>
						</Hidden>
					</Grid>
