...
export default function Studies(props) {
	...
	return (
		<>
			...
			<Hidden mdDown>
				<img
					src="/images/rd/chart3-desktop.svg"
			...
			<Hidden only={['xs', 'sm', 'lg', 'xl']}>
				<img
					src="/images/rd/chart3-tablet.svg"
					className={styles.chart}
					alt={chartAltText}
				/>
			</Hidden>
			<Hidden mdUp>
				<img
					src="/images/rd/chart3-mobile.svg"
					className={styles.chart}
					alt={chartAltText}
				/>
			</Hidden>
			...
			<GridList
				...
				cols={windowWidth < parseInt(scssVariables.md) ? 2 : 5}
				cellHeight="auto">
