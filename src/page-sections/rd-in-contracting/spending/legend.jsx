		...
		if (isMobile) {
			return (
				<div className={styles.chartLegendMobile}>
					<p
						className={`${
							legendTextwrap ? styles.legendItemSmall : styles.legendItem
						}`}>
						<Devotion /> <span>Research and Development Devotion</span>
					</p>
					<p
						className={`${
							legendTextwrap
								? styles.legendItemSmallSpending
								: styles.legendItemSpending
						}`}>
						<Percentage />{' '}
						<span> Percentage of Agency's Total Contract Spending </span>
					</p>
				</div>
			);
		} else {
