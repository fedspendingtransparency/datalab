...
export default function createMobileSpendingViz(
	config,
	height,
	width,
	dotsHeight
	...
	revenueText
		...
		.append('tspan')
		.text(formatNumber('dollars suffix', config.revenueAmount, 3))
		.attr('font-size', 14)
		.attr('font-weight', 'normal')
		.attr('x', 0)
		.attr('dy', 16);

	const spendingRect = svg
		.append('g')
	...
	spendingText
		...
		.call(wordWrap, width * 0.15)
		.append('tspan')
		.text(formatNumber('dollars suffix', config.spendingAmount, 3))
		.attr('font-size', 14)
		.attr('font-weight', 'normal')
		.attr('x', 0)
		.attr('dy', 16);

	d3.selectAll('.revenue-text>text').attr('y', revenueRectHeight * 0.5 - 4);

	d3.selectAll('.spending-text>text').attr('y', spendingRectHeight * 0.5 - 4);
