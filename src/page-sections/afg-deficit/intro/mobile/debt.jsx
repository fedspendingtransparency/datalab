	...
	return (
		<>
			...
			<div className="deficit-tab-text">
				...
				the government owes is essentially the accumulation of deficits over
				time, minus repayments of debt.
				<div className="deficit-tab-subtext">
					*The {AfgData.added_debt_short.value} increase in federal debt
					actually consists of the {AfgData.current_fy_deficit_short.value}{" "}
					deficit along with changes to operating cash balance,
					intergovernmental holdings, and other financial activities. In the
					visualization, the operating cash balance, intergovernmental holdings,
					and other financial activities were combined with the prior year debt
