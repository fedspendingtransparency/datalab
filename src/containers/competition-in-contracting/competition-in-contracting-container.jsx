...
import competitionStyles
	from 'src/pages/competition-in-contracting/competition-in-contracting.module.scss';
			...
			<div className={competitionStyles.vizContainer}>
				<Grid container className={competitionStyles.container}>
					<Grid alignItems="stretch" container id={competitionStyles.summary}>
						...
						<Grid item xs={6} md={3} lg={2} className={competitionStyles.summaryItem}>
							<Grid container alignItems="flex-end">
								<Grid item xs={12} className={competitionStyles.summaryItemCompeted}>
									$ COMPETED
								</Grid>
						...
						<Grid item xs={6} md={3} lg={3} className={competitionStyles.summaryItem}>
							<Grid container alignItems="flex-end">
								<Grid item xs={12} className={competitionStyles.summaryItemNotCompeted}>
									$ NOT COMPETED
								</Grid>
					...
					<div className={competitionStyles.legendDiv}>
						<div
							className={competitionStyles.legend}
							id={competitionStyles.notCompeted}>
							<svg height="15" width="15">
								<circle cx="7.5" cy="7.5" r="7.5" />
							</svg>
							<label
								htmlFor={competitionStyles.notCompeted}
								style={{
									fontSize: '0.75rem',
						...
						<div className={competitionStyles.legend} id={competitionStyles.competed}>
							...
							<label
								htmlFor={competitionStyles.competed}
								style={{
									fontSize: '0.75rem',
									verticalAlign: 'bottom',
						...
						<div className={competitionStyles.barChartToolbar}>
							<div className={competitionStyles.selectWrapper1}>
								...
								<label
									...
									style={{ fontSize: '0.75rem', padding: '0 .5rem 0 .1rem' }}>
									Quantity
								</label>
					...
					<div id="bar-chart-div" className={competitionStyles.barChartDiv}>
						<Barchart
							...
							_svgClass={competitionStyles.svg}></Barchart>
						<Downloads data={this.state.data} isJSON={true} />
					</div>
				</Grid>
			</div>
		);
