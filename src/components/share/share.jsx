	...
	constructor(props) {
		...
		if (this.pathName) {
			...
			for (let i = pathNameSplit.length; i--; ) {
				pathNameSplit[i] =
					pathNameSplit[i].charAt(0).toUpperCase() + pathNameSplit[i].slice(1);
			}
	...
	handleShareClick = e => {
		...
		if (
			...
			const twitterText = encodeURIComponent(
				this.props.twitter || this.props.text || this.title
			);
			...
			finalUrl = `mailto:?subject=${this.title}&body=${
				this.props.text ? encodeURIComponent(this.props.text) + '%0D%0A%0D%0A' : ''
			}Check out this site ${this.url}`;
		...
		return (
			<div className={styles.shareContainer}>
				<div className={`${styles.popup} ${styles.newShare}`}>
					...
					<span
						className={`${styles.popuptext} ${styles.right} ${styles.newpopup} ${
							...
							<ul>
								<li>
									<button
										...
										/>
										<span id="facebook-label" className={styles.shareButtonText}>
											Facebook
										</span>
									</button>
								</li>
								<li>
									<button
										...
										/>
										<span id="twitter-label" className={styles.shareButtonText}>
											Twitter
										</span>
									</button>
								</li>
								<li>
									<button
										...
										<img
											...
											className={styles.iconReddit}
										/>
										<span id="reddit-label" className={styles.shareButtonText}>
											Reddit
										</span>
									</button>
								</li>
								<li>
									<button
										...
										/>
										<span id="linkedin-label" className={styles.shareButtonText}>
											Linkedin
										</span>
									</button>
								</li>
								<li>
									<button
										...
										/>
										<span id="email-label" className={styles.shareButtonText}>
											Email
										</span>
									</button>
								</li>
