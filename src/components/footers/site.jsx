	...
	<footer className={siteFooterStyles.siteFooter}>
		<Hidden smDown>
			<div>
				...
				<a href="https://www.usaspending.gov/#/about/accessibility">
					Accessibility
				</a>{' '}
				|&nbsp;
				<a href="https://www.usaspending.gov/#/about/privacy">
					Privacy&nbsp;Policy
				</a>{' '}
				|&nbsp;
				<a href="https://www.usaspending.gov/#/about/foia">
					Freedom&nbsp;of&nbsp;Information&nbsp;Act
				</a>
			</div>
			<div className={siteFooterStyles.note}>
				<b>NOTE:</b>{' '}
				<a href="https://beta.usaspending.gov/#/db_info">
